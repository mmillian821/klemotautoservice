      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">We are Freight Forwarding Agent with years of experience clearing cars, trucks, and containers at Tincan Island Port, Apapa Lagos. Whether you're importing a single car or a full container, we offer fast, professional, and reliable clearing services.</p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Fully licensed custom freight forwarders with proper certification</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-900">🚢 Tincan Island Port, Apapa Lagos</h4>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              With full access to Tincan Island Port, Apapa Lagos, we ensure your cargo is handled quickly and 
